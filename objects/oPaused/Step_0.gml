...
if (keyboard_check_pressed(vk_enter) or keyboard_check_pressed(global.keyj)) && oGame.destroy = 0 && oGame.delay >= 10 and !instance_exists(oMenu)
	{
	switch psel {
		case 0: instance_activate_all(); instance_destroy(); break;
		case 1: settingsmenu = true break;
		case 2: instance_activate_all(); room_restart(); break;
