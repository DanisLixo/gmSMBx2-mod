/// @self
/// @description Returns the key asked to a string, so it can be used on text, not all keys are here though.
/// @param {Virtual Key} [Key] A virtual key to be translated.
/// @param {Bool} [Return Uppercase] If it should return in uppercase, necessary for the game's font.
function keycode_to_string(_key,_return_uppercase = true)
{
	var _r = "VALID KEY";
